...
public static b4a.example.boleto _boleto = null;
  public Object[] GetGlobals() {
		return new Object[] {"boleto",Debug.moduleToString(b4a.example.boleto.class),"comun",Debug.moduleToString(b4a.example.comun.class),"funciones",Debug.moduleToString(b4a.example.funciones.class),"HttpUtils2Service",starter.mostCurrent._httputils2service,"inicio",Debug.moduleToString(b4a.example.inicio.class),"Main",Debug.moduleToString(b4a.example.main.class),"Service",starter.mostCurrent._service,"Venta",Debug.moduleToString(b4a.example.venta.class)};
}
}